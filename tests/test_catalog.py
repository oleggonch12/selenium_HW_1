...
def test_camera_catalog(browser):
    time.sleep(1)
...
def test_laptop_catalog(browser):
    time.sleep(1)
...
def test_phones_catalog(browser):
    time.sleep(1)
...
def test_mp3_players_catalog(browser):
    time.sleep(1)
...
@pytest.mark.xfail
def test_non_existence_software_catalog(browser):
    time.sleep(1)
